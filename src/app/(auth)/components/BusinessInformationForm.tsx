    ...
    const onSubmit: SubmitHandler<IFormInput> = async (data) => {
        try {
            ...
            if (response.status === 200) {
                toast.success(`You have successfully compeleted Sign up process. Redirect to Login....`);
                        ...
                        <Flex direction="column" gap={5} mb={10}>
                            ...
                            {provider !== "credentials" && (
                                <FormControl isInvalid={!!errors.businessType}>
                                    ...
                                    <Controller
                                        control={control}
                                        rules={{ required: { value: true, message: 'Business type is required' } }}
                                        name={`businessType`}
                                        render={() => (
                                            <CustomRadio
                                                name="businessType"
                                                ...
                                                onChangeCallback={(selectedValue: string) => {
                                                    const value: 'supplier' | 'customer_pharmacy' = selectedValue == 'Supplier' ? 'supplier' : 'customer_pharmacy';
