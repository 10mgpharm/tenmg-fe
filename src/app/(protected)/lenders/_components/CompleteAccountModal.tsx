      ...
      <ModalContent>
        ...
        <ModalBody>
          <Stack>
            ...
            <p className="text-sm text-gray-500">THIS WILL ENABLE YOU:</p>
          </Stack>
          <Stack>
            <ul className="mt-6 space-y-5">
              <li className="flex items-center gap-3">
                ...
                <p className="text-gray-600">Add your Bank Information</p>
              </li>
              <li className="flex items-center gap-3">
                <Image src={inventory} alt="" className="w-5 h-5" />
                <p className="text-gray-600">Make a Deposit</p>
              </li>
              <li className="flex items-center gap-3">
                <Image src={insight} alt="" className="w-5 h-5" />
                <p className="text-gray-600">Setup Loan Preference</p>
              </li>
            </ul>
          </Stack>
        </ModalBody>
        <ModalFooter mt={3} mb={5}>
          <button
            type="button"
            onClick={() => router.push("/lenders/settings/license-upload")}
