      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-10">
        <div className="rounded-t-xl overflow-hidden">
          ...
          <div className="gap-4 px-5 py-3 bg-white">
            ...
            <div className="space-y-0.5 my-2">
              <p className='text-sm'>Instalment Amount:</p>
              <h4 className="font-semibold text-sm">N150,000 monthly</h4>
            </div>
            <div className="space-y-0.5 my-2">
              <p className='text-sm'>Interest Applied:</p>
        ...
        <div className="rounded-t-xl overflow-hidden">
          ...
          <div className="gap-4 px-5 py-3 bg-white">
            ...
            <div className="space-y-0.5 my-2">
              <p className='text-sm'>Total Transaction Volume </p>
              <h4 className="font-semibold text-sm">N500,000,000.00</h4>
            </div>
            <div className="space-y-0.5 my-2">
              <p className='text-sm'>Average Transaction Amount:</p>
              <h4 className="font-semibold text-sm">N450,000.00</h4>
            </div>
            <div className="space-y-0.5 my-2">
              <p className='text-sm'>Performance Status:</p>
        ...
        <table className='w-full text-center'>
          ...
          <tbody>
            <tr className="border-b border-b-slate-400 text-xs">
              ...
              <td className="py-2">  <Badge colorScheme="yellow" fontSize="10px" px="2" py="1" borderRadius="md">
                Outstanding
              </Badge></td>
            </tr>
          </tbody>
