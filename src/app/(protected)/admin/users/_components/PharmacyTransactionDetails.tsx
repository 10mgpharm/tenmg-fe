...
const Pharm_TransactionDetails = ({
  isOpen,
  onClose,
  type,
}: {
    ...
    <Drawer isOpen={isOpen} placement="right" onClose={onClose} size={"md"}>
      ...
      <DrawerContent>
        ...
        <DrawerBody>
          ...
          <Stack gap={2} mt={4} px={3} py={5} rounded={"md"} className="border">
            <h3 className="text-[15px] font-medium">Products Bought:</h3>
            <p className="text-[15px] text-gray-600">
              Panadol, Paracetamol, Vitamin C
            </p>
          </Stack>
...
export default Pharm_TransactionDetails;
