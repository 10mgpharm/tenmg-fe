...
const InviteMember = ({isOpen, onClose}: {isOpen: boolean, onClose: () => void}) => {
  return (
    <Drawer
        isOpen={isOpen}
        placement='right'
            ...
            <form>
                ...
                <FormControl mb={10}>
                    ...
                    <Flex align={"center"} gap={10}>
                        ...
                        <chakra.span className="text-primary-600 text-sm">Hide Ride Details</chakra.span>
                    </Flex>
                </FormControl>
                <Box p={4} rounded={"md"} bg={"gray.100"}>
                    <Text fontWeight={500} fontSize={"15px"} mb={1}>Role&apos;s Permission</Text>
                ...
                <HStack maxW={"300px"} ml={"auto"} gap={3} mt={6}>
                    ...
                    <Button className='bg-primary-600 text-white w-[65%]'>Invite Member</Button>
                </HStack>
            </form>
          </DrawerBody>
          <DrawerFooter p={0}>
