    ...
    <div className="p-8">
        ...
        <Stack mt={4} className="p-5 rounded-md border bg-white">
            <Flex justify={"space-between"} mb={3}>
                <Stack>
                    <Text fontSize={"15px"} color={"gray.500"}>Loan Amount</Text>
                ...
                <Stack>
                    <Text fontSize={"15px"} color={"gray.500"}>Total Repayment</Text>
                    <Text fontWeight={500} fontSize={"1.2rem"}>₦ 123,849,900</Text>
                </Stack>
                <Stack>
                    <Text fontSize={"15px"} color={"gray.500"}>Duration</Text>
                    <Text fontWeight={500} fontSize={"1.2rem"}>1 year</Text>
                </Stack>
                <Stack>
                    <Text fontSize={"15px"} color={"gray.500"}>Start Date</Text>
                    <Text fontWeight={500} fontSize={"1.2rem"}>1st of July, 2023</Text>
                </Stack>
                <Stack>
                    <Text fontSize={"15px"} color={"gray.500"}>End Date</Text>
                    <Text fontWeight={500} fontSize={"1.2rem"}>1st of July, 2023</Text>
                </Stack>
            </Flex>
            <Divider />
            <Stack mt={3} maxW={"60%"}>
                <Text fontWeight={600} fontSize={"1rem"} mb={2}>Status</Text>
                <ThemeProvider theme={theme}>
                    <Progress h={"34px"} value={70} pos={"relative"}>
                        <chakra.span className="text-white text-center text-sm absolute top-2 inset-x-0">Repayment in Progress  - 75% Complete</chakra.span>
                    </Progress>
                </ThemeProvider>
            </Stack>
        </Stack>
        <Stack mt={4}>
            <Text fontWeight={600} fontSize={"1rem"} mb={2}>Repayment History</Text>
            <div className="mt-5">
        {
