...
const TransactionDetails = (
    {isOpen, onClose, type}: 
    {isOpen: boolean, onClose: () => void, type: string}
) => {
  return (
    <Drawer
        isOpen={isOpen}
      ...
      >
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <Text color={"gray.900"} fontWeight={600} fontSize={"1.4rem"}>$9000</Text>
            <Text fontSize={"13px"} color={"gray.500"}>Tue, 10 Sept 2024, 19:40</Text>
            <Stack mt={5}>
                <Text fontSize={"14px"} color={"gray.500"}>Details</Text>
            ...
            <Stack gap={4} mt={4} px={3} py={5} rounded={"md"} className='border'>
                <Flex  justify={"space-between"}>
                    <Text>Status</Text>
                    <Tag colorScheme={"green"}  fontWeight={500}>Completed</Tag>
                </Flex>
                <Flex  justify={"space-between"}>
