  ...
  return (
    <div>
      {orders?.data?.length === 0 ? (
        <EmptyOrder
          heading={`No ${type === "all" ? "" : type.toLowerCase()} Order Yet`}
      ...
      >
        <div className="mb-8">
          <p className="leading-6 text-gray-500 mt-2">
            ...
            Click proceed if you wish to continue.
          </p>
      ...
      >
        <div className="mb-8">
          <p className="leading-6 text-gray-500 mt-2">
            You are about to change the status of this order to
            <span className="font-semibold text-gray-600"> Refunded</span>.
            Click proceed if you wish to continue.
          </p>
          <div className="flex justify-end gap-3 mt-8">
            <Button
