                    ...
                    <div className="border rounded-md">
                        ...
                        <div className="space-y-3 p-4">
                            <div className="">
                                ...
                                <p className="text-sm font-medium text-gray-700">Samule Ajayi</p>
                            </div>
                            <div className="">
                                <p className="text-sm text-gray-500">Email</p>
                                <p className="text-sm font-medium text-gray-700">sunday.ajayi@lendsqr.com</p>
                            </div>
                            <div className="">
                                <p className="text-sm text-gray-500">Evaluation ID</p>
                                <p className="text-sm font-medium text-gray-700">EVAL-44S-333</p>
                            </div>
                            <div className="">
                        ...
                        <div className="border rounded-md p-5">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-1">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-700">₦16,060,230</h3>
                                </div>
                                <div className="space-y-1">
                                    <p className="text-sm text-gray-400">Max Amount</p>
                                    <h3 className="text-lg font-semibold text-gray-700">₦160,060,000</h3>
                                </div>
                            </div>
                        </div>
                    </div>
