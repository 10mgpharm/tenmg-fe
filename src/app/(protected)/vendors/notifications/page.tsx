...
import NewPagination from "../../suppliers/_components/ResponsivePagination";
...
const Notifications = () => {
  ...
  const handleItemClick = (id: string) => {
    ...
    router.replace(`/vendors/notifications?${currentParams.toString()}`, {
      scroll: false,
    });
  };
      ...
      {loading ? (
        ...
        <div className="flex rounded-sm m-4 bg-white">
          <div className="border-r h-[calc(100vh-150px)] w-[380px] overflow-y-scroll overflow-x-hidden">
            <h2 className="text-xl font-semibold mb-2 px-4 mt-5">
              My Notifications
            </h2>
            <button
              onClick={markAllAsRead}
              className="text-primary-500 font-medium text-sm mb-6 px-4"
            >
              Mark all as read
            </button>
            <div>
                      ...
                      >
                        <p className="px-4">
                          {notification?.data?.subject &&
                            truncateString(notification?.data?.subject, 76)}
                        </p>
                ...
                <div>
                  <div className="flex items-center gap-5">
                    <div className="inline-flex p-1 bg-blue-100 text-blue-600 rounded-full">
                      <IoMdNotificationsOutline className="w-10 h-10 cursor-pointer" />
                    </div>
