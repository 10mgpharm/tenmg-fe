    ...
    <div className="p-5">
        <div className="border rounded-lg shadow-sm bg-white p-4">
            ...
            <div className="border rounded-md mt-4">
                ...
                <SimpleGrid columns={[5]} px={4} py={3}>
                    <GridItem>
                        <Stack gap={0.5}>
                    ...
                    <GridItem justifySelf={"center"}>
                        <Stack gap={0.5}>
                            <Text fontSize={"14px"} color={"gray.600"}>Email</Text>
                    ...
                    <GridItem justifySelf={"center"}>
                        <Stack gap={0.5}>
                            ...
                            <Text pl={"20px"} fontWeight={"medium"}>{customersData?.businessId}</Text>
                        </Stack>
                    </GridItem>
                    <GridItem justifySelf={"center"}>
                        <Stack gap={0.5}>
                            <Text fontSize={"14px"} color={"gray.600"}>Customer ID</Text>
                            <Text pl={"20px"} fontWeight={"medium"}>{customersData?.id}</Text>
                        </Stack>
                    </GridItem>
                    <GridItem justifySelf={"center"}>
                        <Stack gap={0.5}>
                            <Text fontSize={"14px"} color={"gray.600"}>Status</Text>
                            {
                                customersData?.active === 1 ? 
                                <Tag size={"sm"} colorScheme={"green"} maxW={"max-content"}>Active</Tag> :
                                <Tag size={"sm"} colorScheme={"red"} maxW={"max-content"}>Disabled</Tag>
                            }
                        </Stack>
                    </GridItem>
                </SimpleGrid>
                ...
                <div className="my-[8rem]">
                    <div className="max-w-md mx-auto space-y-5">
                        <div className="w-full text-center mx-auto">
                            <button onClick={onOpen} className="py-2 px-3 rounded-md text-white bg-primary-600 max-w-max">
                                Upload Transaction History
                            </button>
                        </div>
                        <p className="text-[15px] text-center">There is no current transaction history evaluated for this customer. Kindly click the button to Evaluate transaction</p>
                    </div>
                </div>
            }
        </div>
