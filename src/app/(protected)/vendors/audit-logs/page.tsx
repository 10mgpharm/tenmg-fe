...
const AuditLogs = () => {
    ...
    const [auditLogCSV, setAuditLogCSV] = useState<any>([{}])
    const headers = [
    ...
    return (
        <div className="p-8">
            <HStack justifyContent={"space-between"}>
                ...
                >
                    <CSVLink data={auditLogCSV} headers={headers} filename={"audit-logs.csv"} target="_blank">
                        Export Data
                    </CSVLink>
                </Button>
            </HStack>
            ...
            <Tabs>
                ...
                <TabPanels>
                    <TabPanel>
                        <ActivityLogs setAuditLogCSV={setAuditLogCSV} />
                    </TabPanel>
                    <TabPanel>
                        <ApiLogs />
                    </TabPanel>
