...
import { useShoppingList } from "@/app/(protected)/storefront/(NoSideMenu)/storeFrontState/useShoppingList";
// import { useStoreAddressList } from "@/app/(protected)/storefront/(NoSideMenu)/storeFrontState/useStoreAddressList";

interface IStoreAddressInput {
  productName: string;
  purchaseDate: string;
  brandName: string;
  description: string;
...
export default function AddStoreAddress() {
  ...
  const onSubmit = async (data) => {
    ...
    toast.success("Item added to store address list successfully");
    reset();
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={handleModalClose} size={"xl"}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Add Item to Store Address List</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
