...
import DateComponent from "../../products/_components/DateComponent";
...
const LicenseUpload = () => {
  ...
  const simulateLocalUpload = () => {
    ...
    }, 200); // increments progress every 200ms for a quick simulation
  };
  ...
  const onSubmit = async (value: IFormInput) => {
    ...
    try {
      ...
      }).post("/supplier/settings/license", formData);
