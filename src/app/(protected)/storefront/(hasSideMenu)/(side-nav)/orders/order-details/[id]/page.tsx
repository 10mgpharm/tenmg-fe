  ...
  return (
    <>
      {loading ? (
        <Box
          my={"16px"}
          className="border border-gray-100 p-8 rounded-md flex items-center justify-center"
        >
          <Spinner />
        </Box>
      ) : (
        <Box my={"16px"}>
                  ...
                  <div className="flex flex-col items-center relative">
                    <StepIndicator className="border-none">
                      <StepStatus
                        complete={<StepIcon />}
                        incomplete={
                          <FaDotCircle className="w-full h-full fill-gray-300" />
                        }
                        active={
                          <FaDotCircle className="w-full h-full fill-primary" />
                        }
                      />
                    </StepIndicator>
          ...
          <Box className="border border-gray-100 p-8 rounded-md my-8">
            ...
            <div>
              <h4 className="font-semibold">{order?.deliveryAddress}</h4>
