...
export default function EmptyStoreFront() {
  return (
    <section className='w-11/12 lg:w-10/12  py-20 mx-auto flex flex-col items-center justify-center gap-4'>
      ...
      <div>
        <p className='text-base my-2 text-center'>There is no product to show at this time.</p>

        <p className='text-xl font-semibold my-4 text-center'>Please check back later.</p>
