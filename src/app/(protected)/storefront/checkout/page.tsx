  ...
  return (
    <div>
      <Box p={4} mt={2} className='grid grid-cols-1 lg:grid-cols-6 w-full lg:w-10/12 mx-auto gap-8'>
        <div className='col-span-1 lg:col-span-4 border border-r-gray-100 rounded-2xl p-6'>
        ...
        {/* Subtotal */}
        <div className='col-span-1 lg:col-span-2 border border-r-gray-100 rounded-2xl p-6'>
