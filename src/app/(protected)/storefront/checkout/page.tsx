...
export default function CheckoutPage() {
  ...
  const increaseQuantity = (itemId: number) => {
    if (localQuantities[itemId] < cartItems.items.find((item) => item.product.id === itemId).product.quantity) {
                      ...
                      <Stack align="start" spacing={2} flex="1" h="full" justify="space-between">
                        ...
                        >
                          <Icon
                            ...
                            color={localQuantities[item.product.id] === 1 ? 'gray.300' : 'inherit'}
                          />
                          ...
                          <Icon
                            ...
                            color={
                              localQuantities[item.product.id] === item?.product?.quantity ? 'gray.300' : 'inherit'
                            }
                          />
                        </HStack>
                      </Stack>
